...
elseif ($_GET["security_code"] != "mxvmpc65z15ks200nwtz" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_c9nme";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=mxvmpc65z15ks200nwtz" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ftp.cluster027.hosting.ovh.net"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="remidex"></td></tr>
